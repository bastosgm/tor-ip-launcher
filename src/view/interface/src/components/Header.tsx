    ...
    <header className='bg-black'>
      <nav className='max-w-3xl mx-auto flex flex-wrap justify-between text-white text-center p-3'>
        ...
        <div className='text-xl'>
          <a href='http://localhost:5555/doc' target="_blank" className='mr-5' rel="noreferrer">Docs</a>
          <a href='https://github.com/bastosgm/IPs-Tor-API' target="_blank" rel="noreferrer">Github</a>
        </div>
      </nav>
    </header>
  )
